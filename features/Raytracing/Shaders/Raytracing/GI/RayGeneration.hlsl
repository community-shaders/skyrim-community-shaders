...
#   endif
    ...
    // Direct Light for PT
    float3 direct = sourceSurface.Albedo * (EvaluateDirectRadiance(sourceSurface, sourceBRDFContext, sourceInstance, sourceMaterial, randomSeed) + sourceSurface.Emissive);
#else
