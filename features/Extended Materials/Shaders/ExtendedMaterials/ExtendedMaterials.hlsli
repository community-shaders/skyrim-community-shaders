...
#		endif
		out float weights[6])
	{
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[0] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[0], TexLandDisplacement0Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[0]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[1] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[1], TexLandDisplacement1Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[1]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[2] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[2], TexLandDisplacement2Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[2]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[3] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[3], TexLandDisplacement3Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[3]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[4] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[4], TexLandDisplacement4Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[4]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[5] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[5], TexLandDisplacement5Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[5]);
#		else
...
#		endif
		out float weights[6])
	{
		...
		if (w1.x > 0.01) {
			...
			{
#		if defined(TERRAIN_VARIATION)
				heights[0] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[0], TexLandTHDisp0Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[0]);
#		else
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				heights[0] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[0], TexColorSampler, SampTerrainParallaxSampler, coords, sharedOffset).w, params[0]);
#		else
...
#		endif
		...
		if (w1.y > 0.01) {
			...
			{
#		if defined(TERRAIN_VARIATION)
				heights[1] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[1], TexLandTHDisp1Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[1]);
#		else
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				heights[1] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[1], TexLandColor2Sampler, SampTerrainParallaxSampler, coords, sharedOffset).w, params[1]);
#		else
...
#		endif
		...
		if (w1.z > 0.01) {
			...
			{
#		if defined(TERRAIN_VARIATION)
				heights[2] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[2], TexLandTHDisp2Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[2]);
#		else
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				heights[2] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[2], TexLandColor3Sampler, SampTerrainParallaxSampler, coords, sharedOffset).w, params[2]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[3] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[3], TexLandTHDisp3Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[3]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[3] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[3], TexLandColor4Sampler, SampTerrainParallaxSampler, coords, sharedOffset).w, params[3]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[4] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[4], TexLandTHDisp4Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[4]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[4] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[4], TexLandColor5Sampler, SampTerrainParallaxSampler, coords, sharedOffset).w, params[4]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[5] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[5], TexLandTHDisp5Sampler, SampTerrainParallaxSampler, coords, sharedOffset).x, params[5]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			heights[5] = ScaleDisplacement(StochasticEffectNoHeight(screenNoise, mipLevels[5], TexLandColor6Sampler, SampTerrainParallaxSampler, coords, sharedOffset).w, params[5]);
#		else
