...
#		endif
		out float weights[6])
	{
		...
		{
#		if defined(TERRAIN_VARIATION)
			float h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[0], TexLandDisplacement0Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[0]);
#		else
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			float h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[1], TexLandDisplacement1Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[1]);
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			float h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[2], TexLandDisplacement2Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[2]);
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			float h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[3], TexLandDisplacement3Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[3]);
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			float h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[4], TexLandDisplacement4Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[4]);
...
#		endif
		...
		{
#		if defined(TERRAIN_VARIATION)
			float h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[5], TexLandDisplacement5Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[5]);
...
#		endif
		out float weights[6])
	{
		...
		if (w1.x > 0.0) {
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[0], TexLandTHDisp0Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[0]);
#		else
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[0], TexColorSampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).w, params[0]);
...
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[1], TexLandTHDisp1Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[1]);
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[1], TexLandColor2Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).w, params[1]);
...
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[2], TexLandTHDisp2Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[2]);
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[2], TexLandColor3Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).w, params[2]);
...
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[3], TexLandTHDisp3Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[3]);
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[3], TexLandColor4Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).w, params[3]);
...
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[4], TexLandTHDisp4Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[4]);
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[4], TexLandColor5Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).w, params[4]);
...
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[5], TexLandTHDisp5Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).x, params[5]);
...
#		endif
			...
			{
#		if defined(TERRAIN_VARIATION)
				h = ScaleDisplacement(StochasticEffect(screenNoise, mipLevels[5], TexLandColor6Sampler, SampTerrainParallaxSampler, coords, sharedOffset, dx, dy).w, params[5]);
