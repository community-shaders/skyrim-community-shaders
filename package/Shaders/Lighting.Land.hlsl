...
#if (defined(LANDSCAPE)) && !defined(VC)
#	define VC
...
#	if defined(EXTENDED_MATERIALS) && (defined(LANDSCAPE) || defined(TRUE_PBR))
#		define EMAT
#	endif
...
#	if defined(EXTENDED_TRANSLUCENCY) && !(0 || 0 || 0 || 0 || 0 || 0 || 0 || 0)
