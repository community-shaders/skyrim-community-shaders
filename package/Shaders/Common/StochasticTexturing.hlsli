#ifndef STOCHASTICTEXTURING_HLSLI
#define STOCHASTICTEXTURING_HLSLI
...
float3 StochasticSample(Texture2D tex, SamplerState samplerTex, float2 UV)
{
...
#endif  // STOCHASTICTEXTURING_HLSLI