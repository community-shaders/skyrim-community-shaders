...
struct GrassCollision : Feature
{
	...
	virtual inline std::string GetFeatureDescription() override { return "Grass Collision makes grass react to actors walking through it by bending and moving away."; }
