...
struct Skylighting : Feature
{
	...
	virtual inline std::string GetFeatureDescription() override { return "Skylighting improves outdoor illumination by simulating realistic atmospheric scattering and bounce lighting based on sky conditions."; }
