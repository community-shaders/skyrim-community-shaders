...
void SkySync::DataLoaded()
{
	...
	stl::detour_thunk<VolumetricLightingDescriptor_Get>(REL::RelocationID(100297, 107014));
...
SkySync::VolumetricLightingDescriptor* SkySync::VolumetricLightingDescriptor_Get::thunk()
{
