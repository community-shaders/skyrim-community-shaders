...
{
	// Create D3D12 device and command queue first (matching dev branch)
...
HRESULT DX12SwapChain::Present(UINT SyncInterval, UINT Flags)
{
	...
	globals::features::upscaling.fidelityFX.Present(globals::features::upscaling.settings.frameGenerationMode);
