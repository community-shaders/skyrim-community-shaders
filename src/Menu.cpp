...
void Menu::DrawSettings()
{
	...
	auto title = "$Community Shaders Version"_i18n(Util::GetFormattedVersion(Plugin::VERSION));
...
void Menu::DrawFooter()
{
	...
	ImGui::SameLine();
	ImGui::BulletText("$D3D12 Interop"_i18n(globals::upscaling->d3d12Interop ? "$Active"_i18n_cs : "$Inactive"_i18n_cs).c_str());
	ImGui::SameLine();
