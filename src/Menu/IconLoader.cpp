...
namespace Util::IconLoader
{
	...
	void LoadThemeSpecificIcons([[maybe_unused]] Menu* menu, [[maybe_unused]] ID3D11Device* device, [[maybe_unused]] const std::vector<IconDefinition>& iconDefs)
	{
		// Theme switching removed - no theme-specific icon overrides
	}
