	...
	const std::function<void()>& drawAdvancedSettings)
{
	...
	std::vector<std::string> categoryOrder = { "Display", "Utility", "Characters", "Grass", "Lighting", "Materials", "Transparency", "Post-Processing", "Sky", "Landscape & Textures", "Water", "Other" };
